export default function KpiCard({ title, number, Icon }) {
    return (
        <div className="flex justify-between p-4 px-8 shadow-sm bg-white rounded-lg min-w-[250px] hover:scale-105 hover:shadow-lg transition-all duration-300 ease-in-out">
